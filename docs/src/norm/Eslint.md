<!--
 * @Author: 柯军
 * @Date: 2019-08-14 12:21:39
 * @Description: 
 -->
[ESLint](https://cn.eslint.org/) 是一款开源的 JavaScript lint 工具，由 Nicholas C. Zakas 于2013 年创建。

[ESLint 官方文档 About 页面](https://cn.eslint.org/docs/about/) 分 About 和 Philosophy 两个部分对 ESLint 做了介绍，简洁明了，值得一读。
