...
![image-20210319153457812](gulp.assets/image-20210319153457812.png)

## 命令

![image-20210319152641717](gulp.assets/image-20210319152641717.png)
...
![image-20210319153753756](gulp.assets/image-20210319153753756.png)

## Build

打包命令和开发命令一样区分版本，会根据版本不同打入对应的文件。

![image-20210319154303378](gulp.assets/image-20210319154303378.png)
...
![image-20210319155545752](gulp.assets/image-20210319155545752.png)
...
![image-20210319160319685](gulp.assets/image-20210319160319685.png)
...
![image-20210319160959717](gulp.assets/image-20210319160959717.png)

执行命令和效果如下，svn，git都可以执行，终于可以解放了~

`npm run build -- --setV --merge=xbond --m=feat:测试功能添加 --push`

![image-20210319161812684](gulp.assets/image-20210319161812684.png)

![image-20210319161824729](gulp.assets/image-20210319161824729.png)

![image-20210319161847251](gulp.assets/image-20210319161847251.png)
